...
```{r, echo=TRUE, include=FALSE, warning = FALSE, message=FALSE, eval=FALSE }
library(politicxsentwitteR)
network <- get_network_data("diputados")
```


<img src="https://github.com/guadag12/SAAP2021/raw/main/images/interior_pp.png" width="120%" />
...
library(tidyverse)
library(plotly)
url <- "https://github.com/guadag12/SAAP2021/blob/main/images/data_visitas.xlsx?raw=true"
destfile <- "data_visitas.xlsx"
curl::curl_download(url, destfile)
data_visitas <- read_excel(destfile)
p <- data_visitas %>%
